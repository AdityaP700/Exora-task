...
export function CompetitorSentimentCard({ companyName }: CompetitorSentimentCardProps) {
  return (
    <div className="bg-card-primary rounded-xl p-6 border border-white/10 shadow-lg transition-all duration-300 ease-in-out transform hover:scale-[1.02] hover:shadow-lg hover:shadow-blue-500/20">
      ...
      <div className="h-32">
        <ResponsiveContainer width="100%" height="100%">
          <AreaChart data={data} margin={{ top: 5, right: 0, left: 0, bottom: 5 }}>
            <defs>
              <linearGradient id="colorUvComp" x1="0" y1="0" x2="0" y2="1">
                <stop offset="5%" stopColor="#3B82F6" stopOpacity={0.8}/>
                <stop offset="95%" stopColor="#3B82F6" stopOpacity={0}/>
              </linearGradient>
            </defs>
            <Area type="monotone" dataKey="uv" stroke="#3B82F6" strokeWidth={2} fill="url(#colorUvComp)" />
          </AreaChart>
        </ResponsiveContainer>
      </div>
